  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-background text-foreground overflow-hidden transition-colors duration-300">
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="hero-subtitle text-base sm:text-lg md:text-xl text-muted-foreground mb-4 max-w-3xl mx-auto leading-relaxed opacity-100 visible">
                The smartest way for IT students to create professional SIWES logbook entries. Just
                describe your week, and watch SwiftLog&apos;s AI craft detailed daily logs.
              </p>
                    ...
                    <div className="space-y-4">
                      <div className="text-left">
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 text-gray-700 text-sm leading-relaxed">
                          This week I worked on database optimization, attended team meetings, and
                          completed user interface testing for the mobile app...
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="text-left">
                        ...
                        <div className="space-y-3">
                          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100 rounded-xl p-4 text-sm">
                            <strong className="text-indigo-700">Monday:</strong>{" "}
                            <span className="text-gray-700">
                              Analyzed database performance metrics and identified bottlenecks...
                            </span>
                          </div>
                          <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-100 rounded-xl p-4 text-sm">
                            <strong className="text-purple-700">Tuesday:</strong>{" "}
                            <span className="text-gray-700">
        ...
        <section
          id="features"
          className="trusted-section py-12 md:py-16 overflow-hidden bg-background transition-colors duration-300"
        >
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="relative">
              ...
              <div className="overflow-hidden">
                <div
                  className="university-carousel flex items-center space-x-16"
                  style={{ width: "200%" }}
                >
                  {/* First Set */}
                  {[
        ...
        <section
          id="process"
          className="py-16 md:py-24 px-4 md:px-6 bg-secondary/30 dark:bg-background transition-colors duration-300"
        >
              ...
              {[
                {
                  ...
                  description:
                    "Simply describe what you accomplished during the week in your own words. No formatting required.",
                  detail:
                    "Just type naturally about your tasks, projects, meetings, and learning experiences.",
                },
                {
                  step: "2",
                  title: "AI Generates Daily Logs",
                  description:
                    "Our intelligent AI breaks down your summary into detailed, professional daily entries.",
                  detail:
                    "Each day gets specific activities, learning outcomes, and professional language.",
                },
                {
                  step: "3",
                  title: "Review & Save",
                  description:
                    "Edit any details if needed, then save to your organized logbook collection.",
                  detail:
                    "Your logs are automatically formatted and ready for submission to supervisors.",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
                ...
                >
                  ...
                  <div className={`flex-1 ${index % 2 === 1 ? "md:text-right" : ""}`}>
                    ...
                    <p className="text-lg text-card-foreground mb-2 leading-relaxed">
                      {item.description}
                    </p>
